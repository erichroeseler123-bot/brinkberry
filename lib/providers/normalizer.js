...
function normalizeCategory(rawCategory, tags = []) {
  ...
  // 2. Core verticals & discovery domains
  ...
  if (/library|book club|storytime|workshop|community center|neighborhood|volunteer|trivia|arcade|bowling|meetup/i.test(text)) return 'community';
