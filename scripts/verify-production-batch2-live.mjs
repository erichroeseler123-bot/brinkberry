// scripts/verify-production-batch2-live.mjs
// Audit live production market feeds on brinkberry.com across all live venues (Batch 1 + Batch 2 + Expansion)

import fs from 'node:fs';

const PROD_HOST = process.env.PROD_HOST || 'https://brinkberry.com';

const ALL_LIVE_MARKETS = [
  // Expansion & Earlier
  ...
  // Batch 2
  { market: 'Indianapolis', venueSlug: 'helium-comedy-club-indianapolis', venueName: 'Helium Comedy Club Indianapolis', lat: 39.7684, lon: -86.1581, timezone: 'America/Indiana/Indianapolis' },
  { market: 'Baltimore', venueSlug: 'magoobys-joke-house-timonium', venueName: "Magooby's Joke House", lat: 39.2904, lon: -76.6122, timezone: 'America/New_York' },
  { market: 'Kansas City', venueSlug: 'comedy-club-of-kansas-city', venueName: 'The Comedy Club of Kansas City', lat: 39.0997, lon: -94.5786, timezone: 'America/Chicago' },
  { market: 'Phoenix', venueSlug: 'stand-up-live-phoenix', venueName: 'Stand Up Live Phoenix', lat: 33.4484, lon: -112.0740, timezone: 'America/Phoenix' },
  { market: 'Tempe', venueSlug: 'tempe-improv', venueName: 'Tempe Improv', lat: 33.4255, lon: -111.9400, timezone: 'America/Phoenix' }
];
...
async function main() {
  console.log('======================================================================');
  console.log(`LIVE PRODUCTION VERIFICATION (${PROD_HOST}) - 11 MARKETS`);
  console.log('======================================================================\n');
  ...
  for (const m of ALL_LIVE_MARKETS) {
  ...
  console.log(`\nTotal Live Official Inventory across all 11 Markets: ${totalOfficial}`);
  ...
  console.log('\n======================================================================');
  console.log('BATCH 2 PRODUCTION PROMOTION & VERIFICATION COMPLETE');
  console.log('======================================================================');
}
